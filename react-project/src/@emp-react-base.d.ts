declare module '@emp/react-base/App' {
  ...
  import '@emp/react-base/styles/reset/index.less'
  import '@emp/react-base/styles/themes/index.less'
...
declare module '@emp/react-base/components/asImg/AsImg' {
  import {FunctionComponent, ImgHTMLAttributes} from 'react'
  interface Props extends ImgHTMLAttributes<HTMLImageElement> {
    defaultSource?: string
  }
  const AsImg: FunctionComponent<Props>
...
declare module '@emp/react-base/components' {
  ...
  export {default as AsImg} from '@emp/react-base/components/asImg/AsImg'
}
declare module '@emp/react-base/configs' {
  export {pollTime} from '@emp/react-base/configs/pollTime'
  export {MENU, INTERNAL_PAGE, ASEIT_INSPECTION_PAGE, ASEIT_SETTING_PAGE, FRIEND_INNER_IFREAM, FRIEND_INNER_PAGE, FRIEND_BLANK_PAGE} from '@emp/react-base/configs/menu'
  /**
   * 头部消息类型 && 告警类型
   */
  const ALARM = 'ALARM'
...
declare module '@emp/react-base/configs/menu' {
  ...
  const ASEIT_INSPECTION_PAGE = 'ASEIT_INSPECTION_PAGE'
  const ASEIT_SETTING_PAGE = 'ASEIT_SETTING_PAGE'
...
declare module '@emp/react-base/layouts/login/configs' {
  import {TypeMenu, TypeOs} from '@emp/react-base/layouts/login'
...
declare module '@emp/react-base/layouts/root/configs' {
  ...
  import {MENU, INTERNAL_PAGE, ASEIT_INSPECTION_PAGE, ASEIT_SETTING_PAGE, FRIEND_INNER_IFREAM, FRIEND_INNER_PAGE, FRIEND_BLANK_PAGE} from '@emp/react-base/configs'
...
declare module '@emp/react-base/utils' {
  ...
  type TypeFunGetSelectOptionByValue = (
    options: TypeOption[],
    value: any,
    config?: {
      valueKey: string
  ...
  type TypeFunGetSelectLabelByValue = (
    options: TypeOption[],
    value: any,
    config?: {
      labelKey: string
  ...
  type TypeFunGetTreeDataByKey = (
    treeDatas: TypeTreeData[],
    value: any,
    config?: {
      keyKey: string
      childrenKey: string
  ...
  type TypeFunGetTreeDataTitleByKey = (
    treeDatas: TypeTreeData[],
    value: any,
    config?: {
      titleKey: string
