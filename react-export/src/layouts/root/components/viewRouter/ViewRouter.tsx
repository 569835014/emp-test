...
const ViewRouter: FunctionComponent = () => {
  return (
    <Switch>
      <Route path={'/root'} exact render={() => <Redirect to={'/root/base/home'} />} />
      <Route path={'/root/base/home'} exact component={Home} />
      {/* <Route path={'/root/page404'} exact component={Page404} /> */}

      <Route path={'/root/project/project'} exact component={Project} />
    </Switch>
  )
}
